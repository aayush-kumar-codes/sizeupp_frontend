...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-2xl mx-auto mt-8 p-4">
      ...
      <h2 className="text-2xl font-bold mt-6">Legal disclaimer</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-6">Links to other sites</h2>
      <p>
      This web site contains links to other sites that are not owned or controlled by sizeupp. Please be aware that we, sizeupp, are not responsible for the privacy practices of such other sites. We encourage you to be aware when you leave our site and to read the privacy statements of each and every web site that collects personally identifiable information. This privacy statement applies only to information collected by this web site. Changes in this privacy statement we may update this privacy statement to reflect changes to our information practices. If we make any material changes we will notify you by email (sent to the e-mail address specified in your account) or by means of a notice on this site prior to the change becoming effective. We encourage you to periodically review this page for the latest information on our privacy practices.
      </p>
