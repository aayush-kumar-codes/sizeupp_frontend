            ...
            <div className=" p-6 max-w-7xl mx-auto my-16 ">
                ...
                <div className="text-center w-full px-2 py-12 mx-auto">
                    ...
                    <div className='lg:flex justify-center items-start p-2'>
                        <div className='mx-4'>
                            <img src={Img2} className='w-48 h-60 object-cover rounded-lg mx-auto' alt="Mr. Anil Saraf" />
                            <h2 className="capitalize text-3xl font-bold mt-4">Mr. Anil Saraf</h2>
