    ...
    return (
        <div className="container mx-auto mt-8 p-4">
            ...
            <div className="max-w-4xl mx-auto mb-10">
                ...
                <div
                    className="p-10 mb-8 bg-white rounded-lg border shadow-md  sm:flex sm:items-center xl:py-5 xl:px-12">
                ...
                <div className="p-10 bg-white border shadow-md rounded-lg sm:flex sm:items-center xl:py-5 xl:px-12">
                    <a href="#" className="mr-6 md:mr-12">
                        <img className=" w-full lg:w-[80px] h-[200px] lg:h-[80px] object-cover  mx-auto mb-6 sm:mb-0 "
