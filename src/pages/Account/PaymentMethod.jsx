...
<main
      className="flex min-h-screen w-full flex-col items-center justify-between p-6 lg:p-24"
    >
      <form
        className="bg-white w-full max-w-3xl mx-auto px-4 lg:px-6 py-8 border shadow-md rounded-md flex flex-col lg:flex-row"
      >
