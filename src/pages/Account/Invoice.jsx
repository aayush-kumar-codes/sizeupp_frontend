    ...
    <>
      <section className="bg-gray-50 w-full">
        ...
        <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10" >
          ...
          <div className="sm:w-11/12 lg:w-3/4 mx-auto" ref={invoiceRef}>
            {/* Card */}
            <div className="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl">
                    ...
                    <dl className="grid sm:flex gap-x-3 text-sm">
                      ...
                      <dd className="font-medium text-gray-800">
                        ...
                        <address className="not-italic font-normal">
                          280 SK road, Regency Anatam Dombivali<br />
                        </address>
                      </dd>
                    </dl>
                ...
                <div className="border border-gray-200 p-4 rounded-lg space-y-4">
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
                    <div className="col-span-full sm:col-span-2">
                      ...
                      <p className="font-medium text-gray-800">Oxford Casual Shirt - Sage Green</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-800">1999</p>
                    </div>
                    <div>
                      <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">Amount</h5>
                      <p className="sm:text-end text-gray-800">Rs. 1790</p>
                    </div>
                  </div>
                  <div className="sm:hidden border-b border-gray-200"></div>
                ...
                <div className="w-full max-w-2xl sm:text-end space-y-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                    <dl className="grid sm:grid-cols-5 gap-x-3">
                      ...
                      <dd className="col-span-2 text-gray-500">Rs. 1790.00</dd>
                    </dl>

                    <dl className="grid sm:grid-cols-5 gap-x-3">
                      <dt className="col-span-3 font-semibold text-gray-800">Total:</dt>
                      <dd className="col-span-2 text-gray-500">Rs. 1751.00</dd>
                    </dl>

                    <dl className="grid sm:grid-cols-5 gap-x-3">
                      <dt className="col-span-3 font-semibold text-gray-800">Tax:</dt>
                      <dd className="col-span-2 text-gray-500">Rs. 20.00</dd>
                    </dl>

                    <dl className="grid sm:grid-cols-5 gap-x-3">
                      <dt className="col-span-3 font-semibold text-gray-800">Amount paid:</dt>
                      <dd className="col-span-2 text-gray-500">Rs. 1771.00</dd>
                    </dl>

                    <dl className="grid sm:grid-cols-5 gap-x-3">
                      <dt className="col-span-3 font-semibold text-gray-800">Due balance:</dt>
                      <dd className="col-span-2 text-gray-500">Rs. 0.00</dd>
                    </dl>
                  </div>
                  {/* End Grid */}
                </div>
              ...
              <div className="mt-8 sm:mt-12">
                ...
                <div className="mt-2">
                  <p className="block text-sm font-medium text-gray-800">sizeupp.com</p>
