    ...
    return (
        <section className={`overflow-hidden ${styles.padding}`}>
            ...
            <div className={`${styles.paddingX}`}>
                ...
                <div className="mt-8 text-lg text-gray">Wishlist is not saved permanently yet. Please <Link to="/register" className="underline text-accent">Register</Link> or <Link to="/login" className="underline text-accent">Login</Link></div>
            </div>
                ...
                <div className="mx-auto flex flex-wrap items-center lg:w-4/5">
                    ...
                    <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
                        ...
                        <div className="flex items-center justify-between">
                            <span className="title-font text-xl font-bold text-gray-900">₹2,999</span>
                            <button
                                type="button"
