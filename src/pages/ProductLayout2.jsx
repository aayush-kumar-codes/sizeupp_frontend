...
const ProductLayout2 = () => {
  ...
  const asideStyles = {
    top: `calc(8rem - ${scrollY}px)`, // Adjust the calculation as needed
    left: 'max(0px, calc(40% - 45rem))',
    right: 'auto',
  };
      ...
      <section className="w-full">
        <div className="mx-auto px-2 py-6 lg:px-10">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-4">
            <aside className="hidden lg:block fixed z-20 bg-white inset-0 top-[8rem] left-[max(0px,calc(44%-45rem))] right-auto w-fit pb-10 px-10 overflow-y-auto"
            >
            ...
            <main className=" w-full rounded-lg px-2 lg:col-span-10 lg:h-full lg:ml-[12rem]">
