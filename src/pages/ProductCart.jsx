        ...
        <div className="mx-auto max-w-7xl px-2 lg:px-0">
            <div className="mx-auto max-w-2xl py-8 lg:max-w-7xl">
                ...
                <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-y-4 lg:gap-x-12 xl:gap-x-16">
                    {profile.addresses?.length != 0 && <div className="py-6 px-6 lg:col-span-8 rounded-md border-b-gray-500 shadow-md mt-2">
                    ...
                    {profile.addresses?.length == 0 &&
                        <div className="px-4 lg:col-span-8">
                    ...
                    <section aria-labelledby="cart-heading" className="rounded-lg drop-shadow-md px-2 bg-white lg:col-span-8">
                        ...
                        <div>
                            <dl className=" space-y-1 px-2 py-4">
                                ...
                                <div className="flex items-center justify-between pt-4">
                                    ...
                                    <dd className="text-sm font-medium text-green-700">- ₹ {cart.sub_sub_total ? parseInt(cart.total_price - cart.sub_sub_total) : 0}</dd>
                                </div>
                                <div className="flex items-center justify-between pt-4">
                                    <dt className="flex items-center text-sm text-c-gray-800">
                            ...
                            {cart.sub_sub_total ? <div className="px-2 pb-4 font-medium text-green-700">
                                You will save ₹ {parseInt(cart.total_price - cart.sub_sub_total)} on this order
                            </div> : null}
                            <button
                                type="button"
                    ...
                    {cart.coupon != 'active' ? <section className='mt-16 lg:col-start-9 rounded-lg drop-shadow-md px-4 py-3 bg-white lg:col-span-4 lg:mt-8'>
                        ...
                        <section className='mt-16 lg:col-start-9 rounded-lg drop-shadow-md px-4 py-4 bg-white lg:col-span-4 lg:mt-8'>
                            ...
                            <div className='text-base text-center font-semibold'>You Saved ₹ {parseInt(cart.total_price - cart.sub_sub_total)}</div>
                        </section>
                    }
                </form>
            </div>
